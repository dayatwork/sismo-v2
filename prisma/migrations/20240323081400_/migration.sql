/*
  ...
  - The values [LEAD] on the enum `TeamRole` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "TeamRole_new" AS ENUM ('LEADER', 'MEMBER');
