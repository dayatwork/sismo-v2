...
// ===================== V2 =======================
// ================================================
export async function createTrackerAttachmentTypeLinkV2({
  displayName,
  trackerItemId,
  url,
  ownerId,
  ...
  const attachment = await prisma.attachmentV2.create({
    data: {
      type,
      taskId: trackerItem.taskId,
      trackerItemId: trackerItemId,
...
export async function createTrackerAttachmentTypeFileV2({
  displayName,
  trackerItemId,
  file,
  ownerId,
...
export async function deleteAttachmentByIdV2({
  attachmentId,
  ownerId,
}: {
  attachmentId: string;
  ...
  const attachment = await prisma.attachmentV2.delete({
    where: { id: attachmentId },
  });
  return attachment;
}
