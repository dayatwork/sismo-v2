...
import { createJobLevel } from "~/services/job-level.server";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  // cLoaderFunctionArgs= await requiredPermission(request, "manage:organization");
  // if (!user) {
  ...
  await createJobLevel({ name, organizationId });

  return redirectWithToast(`/app/${organizationId}/organization/job-level`, {
    description: `New job level created`,
    type: "success",
  });
}
...
export default function AddNewJobLevel() {
