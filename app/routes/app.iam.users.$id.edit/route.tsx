...
import { editUser, getUserById, memberStatuses } from "~/services/user.server";
...
export async function loader({ request, params }: LoaderFunctionArgs) {
  ...
  return json({ memberStatuses, user });
}

export default function EditUser() {
  const actionData = useActionData<typeof action>();
  const { memberStatuses, user } = useLoaderData<typeof loader>();
          ...
          <div className="mt-4 grid gap-4 py-4">
            ...
            <div className="grid gap-2">
              <Select
                ...
                defaultSelectedKey={user.memberStatus || "FULLTIME"}
              >
