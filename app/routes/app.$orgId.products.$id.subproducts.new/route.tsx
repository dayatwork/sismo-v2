...
import { createSubProduct } from "~/services/product.server";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  await createSubProduct({ name, description, code, organizationId, parentId });

  return redirectWithToast(
    `/app/${organizationId}/products/${parentId}/subproducts`,
    {
      description: `New subproduct created`,
      type: "success",
    }
  );
}
