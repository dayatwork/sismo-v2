...
import { createOrganizationUser, memberStatuses } from "~/services/user.server";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  try {
    ...
    return redirectWithToast(`/app/${organizationId}/employees`, {
...
export default function AddOrganizationUser() {
  ...
  return (
    <Modal
      isDismissable
      isOpen={true}
      onOpenChange={() => navigate(`/app/${orgId}/employees`)}
        ...
        <Form method="post" {...form.props}>
          ...
          <div className="mt-4 flex justify-end gap-2 w-full">
            <Button
              ...
              onPress={() => navigate(`/app/${orgId}/employees`)}
            >
              Cancel
            </Button>
            <Button
