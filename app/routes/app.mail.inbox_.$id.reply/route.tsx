...
import { type InboxMailDetailOutletContext } from "../app.mail.inbox_.$id/route";
...
export async function action({ request, params }: ActionFunctionArgs) {
  ...
  try {
    ...
    return redirectWithToast(`/app/mail/inbox/${mailId}`, {
    ...
    <div className="mt-4">
      ...
      <Form method="post" id={form.id} onSubmit={form.onSubmit}>
        ...
        <div className="mt-8 flex justify-end">
          <Button
            variant="ghost"
            onClick={() => navigate(`/app/mail/inbox/${id}`)}
          >
            Cancel
          </Button>
